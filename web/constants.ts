...
export class PillarsConstants {
 // Base width and height. Position everything as if it's this
    ...
    static readonly HAND_Y = PillarsConstants.BH - 300;
    static readonly DISCARD_X = 1000;
    static readonly DISCARD_Y = PillarsConstants.BH - 300;
    static readonly HAND_WIDTH = 700;
    static readonly CARD_WIDTH = 200; // 0.725738396624473
    ...
    static readonly PILLARY = 100;
    static readonly PILLAR_SCALE = 0.75;
