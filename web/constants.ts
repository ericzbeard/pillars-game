...
export class PillarsConstants {
 // Base width and height. Position everything as if it's this
    ...
    static readonly PILLAR_SCALE = 0.825;
    static readonly PILLARX = PillarsConstants.BW - 180;
    static readonly PILLARY = 30;
    ...
    static readonly MENUX = 1520;
    static readonly MENUY = 10;
    static readonly MENUW = 160;
    static readonly MENUH = 120;
    static readonly MENU_BUTTON_W = 80;
